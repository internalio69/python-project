...
class HomePage:
    ...
    def initialize(self):
        ...
        self.btn1 = tk.CTkButton(self.window, width=100, height=100, corner_radius=20, image=self.btn1Image, text="", fg_color=("#C7C7C7", "#1D1D1D"), border_spacing=20, border_color=("#B6B6B6", "#1D1D1D"), border_width=1, hover_color=("#B6B6B6", "#161616"), command=self.loadTtsPage)
        ...
        self.btn2 = tk.CTkButton(self.window, width=100, height=100, corner_radius=20, image=self.btn2Image, text="", fg_color=("#C7C7C7", "#1D1D1D"), border_spacing=20, border_color=("#B6B6B6", "#1D1D1D"), border_width=1, hover_color=("#B6B6B6", "#161616"), command=self.loadQrPage)
        ...
        self.btn3 = tk.CTkButton(self.window, width=100, height=100, corner_radius=20, image=self.btn3Image, text="", fg_color=("#C7C7C7", "#1D1D1D"), border_spacing=20, border_color=("#B6B6B6", "#1D1D1D"), border_width=1, hover_color=("#B6B6B6", "#161616"), command=self.loadSpeedTestPage)
    ...
    def loadQrPage(self):
        self.clearWidgets()
        QRCode(self.window, self).initialize()

    def loadSpeedTestPage(self):
        self.clearWidgets()
        SpeedTest(self.window, self).initialize()
    
    def loadTtsPage(self):
        self.clearWidgets()
        TTS(self.window, self).initialize()